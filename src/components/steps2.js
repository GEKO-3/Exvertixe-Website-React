          ...
          <div className="steps2-container3">
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text26">
                      ...
                      objectives in an initial consultation.
                    </span>
                  </Fragment>
                )}
              </span>
            ...
            <div className="steps2-container5 thq-card">
              <h2 className="thq-heading-2">
                {props.step2Title ?? (
                  <Fragment>
                    <span className="steps2-text31">Customized Strategy</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text27">
                      Based on the consultation, we develop a customized
            ...
            <div className="steps2-container6 thq-card">
              <h2 className="thq-heading-2">
                {props.step3Title ?? (
                  <Fragment>
                    <span className="steps2-text29">Implementation</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text32">
                      Our team executes the marketing strategy using a
                      combination of graphic design, web development, and other
                      marketing services.
                    </span>
                  </Fragment>
                )}
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text30">
                      We continuously monitor the performance of the campaigns
