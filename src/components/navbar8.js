        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text22">#case-studies</span>
                </Fragment>
              )}
            </a>
            <div
          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-animated thq-button-filled">
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text21">Get Started</span>
                  </Fragment>
                )}
              </span>
            </button>
              ...
              <div className="navbar8-link4-accordion">
                ...
                >
                  <span className="thq-body-small thq-link">
                    {props.link4 ?? (
                      <Fragment>
                        <span className="navbar8-text15">#testimonials</span>
                      </Fragment>
                    )}
                  </span>
                            ...
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="navbar8-text23">
                                  Discover the range of marketing services we
                                  provide.
                                </span>
                              </Fragment>
                            )}
                ...
                <div className="navbar8-menu-item8">
                  ...
                  <div className="navbar8-content8">
                    <span className="navbar8-page42 thq-body-large">
                      {props.page4 ?? (
                        <Fragment>
                          <span className="navbar8-text26">Testimonials</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
...
Navbar8.defaultProps = {
  page3ImageAlt: 'Image for Case Studies Page',
  ...
  page3ImageSrc:
    'https://images.unsplash.com/photo-1627163439134-7a8c47e08208?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczODM1NjMzM3w&ixlib=rb-4.0.3&q=80&w=1080',
  page2: undefined,
  page1ImageSrc:
    'https://images.unsplash.com/photo-1711919766637-2b11e5b7c711?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczODM1NjMzMnw&ixlib=rb-4.0.3&q=80&w=1080',
  linkUrlPage2: 'https://www.teleporthq.io',
  linkUrlPage3: 'https://www.teleporthq.io',
  page4ImageSrc:
    'https://images.unsplash.com/photo-1468421870903-4df1664ac249?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczODM1NjMzM3w&ixlib=rb-4.0.3&q=80&w=1080',
  ...
  page2ImageAlt: 'Image for Services Page',
  action1: undefined,
  link3: undefined,
  ...
  page4ImageAlt: 'Image for Testimonials Page',
